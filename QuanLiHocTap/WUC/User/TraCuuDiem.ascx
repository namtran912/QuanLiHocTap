...
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr>
        <td>
<asp:GridView ID="GridView_TraCuuDiem" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" EnableModelValidation="True" GridLines="Vertical">
